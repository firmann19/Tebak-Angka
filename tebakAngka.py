...
def show_score():
    if len(attempts_list) <= 0:
        ...
        print("Skor tertinggi terakhir adalah {}".format(min(attempts_list)))
def start_game():
    ...
    while wanna_play.lower() == "ya":
        try:
            guess = input("Pilih sebuah angka antara 1 sampai 10 ")
            ...
            if int(guess) == random_number:
                ...
                print("Tebakan Anda Benar! {}".format(attempts))
